...
class ConvMixerPatchEmbeding(nn.Module):
    """Module use in ConvMixer to tokenise patches of the input image. The module
    applies a convolutional layer to the input image with a kernel and stride
    size equal to the patch size, and an output channel equal to the dimension of the embeddings.
    ...
    def __init__(self, in_channels, embed_dim, patch_size):
        super(ConvMixerPatchEmbeding, self).__init__()
